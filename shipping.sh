...
cp /home/centos/sriv/shipping.service /etc/systemd/system/shipping.service &>>$LOGFILE
...
mysql -h mysql.srivijay.online -uroot -pRoboShop@1 < /app/schema/shipping.sql  &>>$LOGFILE
